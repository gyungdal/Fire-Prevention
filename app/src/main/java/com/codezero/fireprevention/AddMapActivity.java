    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    getLocateInfo getLocateInfo = new getLocateInfo();
                    ...
                    HashMap<String, String> Locate = getLocateInfo.execute(productLocate.getText().toString()).get();
                    if(Locate != null) {
                        double lng = Double.valueOf(Locate.get("lng"));
                        double lat = Double.valueOf(Locate.get("lat"));
